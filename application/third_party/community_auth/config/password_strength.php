...
$config['min_chars_for_password'] = getConfig('min_chars_for_password');
...
$config['max_chars_for_password'] = getConfig('min_chars_for_password');
...
$config['min_digits_for_password'] = getConfig('min_digits_for_password');
...
$config['min_lowercase_chars_for_password'] = getConfig('min_lowercase_chars_for_password');
...
$config['min_uppercase_chars_for_password'] = getConfig('min_uppercase_chars_for_password');
...
$config['min_non_alphanumeric_chars_for_password'] = getConfig('min_non_alphanumeric_chars_for_password');
