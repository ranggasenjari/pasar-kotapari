...
class gisearch {
  ...
  function __construct($SEARCH) {
	...
	if ($IMAGE['src']==null){
		...
		$this->SRC = 'https://pasar.langkatkab.go.id';      // source website
		$this->LINK = 'https://pasar.langkatkab.go.id/rsc/img/noimg.png';    // url of the image
		$this->TITLE = 'tidak ada gambar';  // title of the image
	} else {
		// set up the internal variables
