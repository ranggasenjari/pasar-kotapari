...
$config['mongo_db']['default']['hostname'] = '192.168.4.34';
$config['mongo_db']['default']['port'] = '28019';
$config['mongo_db']['default']['username'] = 'admSimpeg';
$config['mongo_db']['default']['password'] = 'Langkat90';
$config['mongo_db']['default']['database'] = 'simpeg';
