  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	  ...
	  <!-- <div class="btn-group"> -->
		<div class="col-xs-6">
			<button type="button" class="btn btn-default btn-block cariproduk" style="border-color: #140d72;">CARI PRODUK</button>
		</div>
		<div class="col-xs-6">
			<button type="button" class="btn btn-default btn-block caritoko" style="border-color: #140d72;">CARI TOKO</button>
		</div>
	<!-- </div> -->
      </div>
