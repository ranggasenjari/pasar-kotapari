  ...
  <div class="content-wrapper">
    ...
    <section class="content">
	  ...
	  <div class="btn-group">
	  <button type="button" class="btn btn-default">CARI PRODUK</button>
	  <button type="button" class="btn btn-default">CARI TOKO</button>
	  </div>
      </div>
...
$(function () {
	...
	$("#kec, #katproduk, #kondisi, #verif, #sort").on("change", function() {
		...
		window.history.pushState("string", "Title", "?q="+getParam('q', u)+d+k+s+v+sort);
		console.log(u+d+k+s+v+sort);
