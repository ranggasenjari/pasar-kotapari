              ...
              <div class="box-body">
                ...
                <tr>
				  ...
				  <small class="text-muted">Kontak: <?=$c->kontak?></small><br/>
				  	...
				  	<span onClick="PopupCenter('<?php echo base_url(); ?>usaha/viewpeta/<?=$c->id_lokasi?>', 'Lokasi', 650, 450)" class="btn btn-xs bg-yellow map"><i class="fa fa-map-o"></i> Peta Lokasi</span>
