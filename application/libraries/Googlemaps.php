...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyCTMkE68mC81K4_8IZIItcMZG2lN7PSwHA'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $map_height					= "100vh";					// The height of the map container. Any units (ie 'px') can be used. If no units are provided 'px' will be presumed
